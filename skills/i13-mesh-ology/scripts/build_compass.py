...
LADDERS = [
    ...
    {"name": "Data Science Ladder (quantitative)",
     "blurb": "Algorithms meet applied statistics.",
     "steps": ["data-structures-algorithms", "beginning-r", "fundamentals-cpp"]},
    {"name": "Occult & Obscure (the pivot)",
     "blurb": "Death-literature meets modern mind-control.",
     "steps": ["ars-moriendi", "rape-of-the-mind", "eyes-wide-open"]},
    {"name": "Esolang Spectrum (ancestor → minimal → hostile)",
     "blurb": "P'' (1964, parent of Brainfuck) → Brainfuck (minimal) → Malbolge (hostile).",
     "steps": ["p-prime-prime", "brainfuck", "malbolge", "fundamentals-cpp"]},
